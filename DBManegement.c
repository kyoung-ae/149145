...
int insAdminTable(struct InsInfo ins_at) { // case 36 & 46
    struct InsInfo at;
...
int updateAdminwl(struct WhiteListTable up_a) { // case 17
    struct WhiteListTable wt;
